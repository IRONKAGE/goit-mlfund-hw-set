...
*Отримання додаткової інформації про об'єкти вхідного датасету, яка сприятиме подальшому дослідженню та кращому розумінню факторів, які суттєво впливають на міцність бетону, у формі таблиці:*
...
В якості індустріального енкору використано фундаментальну модель **Google TimesFM** (Zero-Shot). Вона симулює криву набору міцності (Curing Curve) у часі (дні затвердіння бетону), виявляючи логарифмічний тренд твердіння без жодного додаткового донавчання на цьому датасеті.
